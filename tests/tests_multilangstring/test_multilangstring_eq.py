...
def test_equality_with_identical_multilangstrings(sample_langstrings_eq):
    """
...
def test_inequality_with_different_langstrings(sample_langstrings_eq):
    """
...
def test_equality_with_different_preferred_lang(sample_langstrings_eq):
    """
...
def test_inequality_with_non_multilangstring_object(sample_langstrings_eq):
    """
...
def test_equality_with_different_control_values(sample_langstrings_eq):
    """
...
def test_equality_with_partial_overlap_in_langstrings(sample_langstrings_eq):
    """
...
def test_equality_with_different_order_of_addition(sample_langstrings_eq):
    """
