...
def test_multilangstring_to_langstrings_with_multiple_languages():
    """
    ...
    ), "multilangstring_to_langstrings should return all LangStrings for all languages"


def test_multilangstring_to_langstrings_with_empty_multilangstring():
    """
...
def test_multilangstring_to_langstrings_with_single_language():
    ...
    assert (
        result == expected
    ), "multilangstring_to_langstrings should return all LangStrings for a MultiLangString with a single language"


@pytest.mark.parametrize("invalid_input", [123, 5.5, True, None, [], {}, LangString("Hello", "en")])
def test_multilangstring_to_langstrings_invalid_type(invalid_input):
    """
