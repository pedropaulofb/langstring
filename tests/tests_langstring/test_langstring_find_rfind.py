...
find_methods_to_test = ["find", "rfind"]
...
@pytest.mark.parametrize("test_case, method", [(tc, m) for tc in find_rfind_test_cases for m in find_methods_to_test])
def test_string_methods_find_rfind(test_case, method):
...
@pytest.mark.parametrize("method", find_methods_to_test)
