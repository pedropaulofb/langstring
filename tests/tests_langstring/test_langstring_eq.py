...
def test_eq_with_various_langstrings(text1: str, lang1: str, text2: str, lang2: str, expected: bool) -> None:
    """
    Test the `__eq__` method for equality with various LangString objects.
...
def test_eq_with_different_object_types(lang_string_text: str, other_object) -> None:
    """
    Test the `__eq__` method for equality with objects of different types.
    ...
    assert not (lang_string == other_object), f"LangString should not be equal to object of type {type(other_object)}"
...
def test_eq_case_insensitive_text(text1: str, text2: str, lang: str, expected: bool) -> None:
    """
    Test the `__eq__` method for case-insensitive text comparison.
...
def test_eq_case_insensitive_language_tag(lang1: str, lang2: str) -> None:
    """
    Test the `__eq__` method for case-insensitive language tag comparison.
...
def test_eq_with_text_and_lang_casing(
    text1: str, lang1: str, text2: str, lang2: str, flag_state: bool, expected: bool
) -> None:
    """
    Test the `__eq__` method for equality with different casing in text and language tags.
