...
@pytest.mark.parametrize("text, lang, expected_text", [
...
def test_capitalize_basic(text, lang, expected_text):
    ...
    assert result.text == expected_text and result.lang == lang, \
...
def test_capitalize_with_whitespace(text, lang):
    ...
    lang_str = LangString(text, lang)
    result = lang_str.capitalize()
    assert result.text == text.capitalize() and result.lang == lang, \
...
def test_capitalize_empty_string(lang):
    ...
    result = lang_str.capitalize()
    assert result.text == "" and result.lang == lang, \
