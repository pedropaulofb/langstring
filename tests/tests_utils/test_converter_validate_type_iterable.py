...
@pytest.mark.parametrize("arg, arg_exp_type, arg_content_exp_type, optional", [
...
def test_validate_type_iterable_valid_cases(arg: Any, arg_exp_type: type, arg_content_exp_type: type, optional: bool) -> None:
    ...
    try:
        ...
        pytest.fail(f"validate_type_iterable raised TypeError unexpectedly for arg: {arg}, type: {arg_exp_type}, content type: {arg_content_exp_type}")

@pytest.mark.parametrize("arg, arg_exp_type, arg_content_exp_type, optional, error_message", [
    ...
    ({"a": 1}, list, int, False, re.escape("Invalid argument with value '{'a': 1}'. Expected 'list', but got 'dict'.")),
    (None, list, int, False, re.escape("Invalid argument with value 'None'. Expected 'list', but got 'NoneType'.")),
    ([1, 2, 3], set, int, False, re.escape("Invalid argument with value '[1, 2, 3]'. Expected 'set', but got 'list'.")),
    ([1.0, "2.0"], list, float, False, re.escape("Invalid argument with value '2.0'. Expected 'float', but got 'str'.")),
    ...
    (["a", "b", 3.14], list, str, False,
     re.escape("Invalid argument with value '3.14'. Expected 'str', but got 'float'.")),
    ([{1: "a"}, {2: "b"}, []], list, dict, False,
     re.escape("Invalid argument with value '[]'. Expected 'dict', but got 'list'.")),
])
def test_validate_type_iterable_invalid_cases(arg: Any, arg_exp_type: type, arg_content_exp_type: type, optional: bool, error_message: str) -> None:
...
def test_validate_type_iterable_nested_valid_cases(arg: Any, arg_exp_type: type, arg_content_exp_type: type, optional: bool) -> None:
...
@pytest.mark.parametrize("arg, arg_exp_type, arg_content_exp_type, optional, error_message", [
    ([{1: "a"}], list, set, False, re.escape("Invalid argument with value '{1: 'a'}'. Expected 'set', but got 'dict'.")),
    ([{"key": "value"}], list, list, False, re.escape("Invalid argument with value '{'key': 'value'}'. Expected 'list', but got 'dict'.")),
    ([{1, 2}], list, dict, False, re.escape("Invalid argument with value '{1, 2}'. Expected 'dict', but got 'set'.")),
    ([['a', 1]], list, str, False, re.escape("Invalid argument with value '['a', 1]'. Expected 'str', but got 'list'.")),
    ([{"a": 1}, {2: "b"}], list, list, False,
     re.escape("Invalid argument with value '{'a': 1}'. Expected 'list', but got 'dict'.")),
])
def test_validate_type_iterable_nested_invalid_cases(arg: Any, arg_exp_type: type, arg_content_exp_type: type, optional: bool, error_message: str) -> None:
