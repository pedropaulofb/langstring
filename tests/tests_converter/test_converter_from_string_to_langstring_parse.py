...
@pytest.mark.parametrize("string, separator, expected_exception, match", [
    (123, "@", TypeError, "Invalid argument with value '123'. Expected 'str', but got 'int'."),  # Invalid string type
    ("Hello@World", 123, TypeError, "Invalid argument with value '123'. Expected 'str', but got 'int'."),  # Invalid separator type
    ("Hello@World", None, TypeError, "Invalid argument with value 'None'. Expected 'str', but got 'NoneType'."),  # None separator
    (None, "@", TypeError, "Invalid argument with value 'None'. Expected 'str', but got 'NoneType'."),  # None string
    ([], "@", TypeError, re.escape("Invalid argument with value '[]'. Expected 'str', but got 'list'.")),  # List as string
    (set(), "@", TypeError, re.escape("Invalid argument with value 'set()'. Expected 'str', but got 'set'.")),  # Set as string
    ("Hello@World", [], TypeError, re.escape("Invalid argument with value '[]'. Expected 'str', but got 'list'.")),  # List as separator
    ("Hello@World", set(), TypeError, re.escape("Invalid argument with value 'set()'. Expected 'str', but got 'set'.")),  # Set as separator
    ("", 123, TypeError, "Invalid argument with value '123'. Expected 'str', but got 'int'."),  # Empty string with invalid separator type
])
