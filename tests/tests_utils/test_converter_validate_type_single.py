...
@pytest.mark.parametrize("arg, arg_exp_type, optional", [
    (1, int, False),
    ("test", str, False),
    (3.14, float, False),
    (True, bool, False),
...
@pytest.mark.parametrize("arg, arg_exp_type, optional, error_message", [
    ...
    (set(), int, False, re.escape("Invalid argument with value 'set()'. Expected 'int', but got 'set'.")),  # Empty set
    ((), int, False, re.escape("Invalid argument with value '()'. Expected 'int', but got 'tuple'.")),  # Empty tuple
    ...
    ("😀", int, False, re.escape("Invalid argument with value '😀'. Expected 'int', but got 'str'.")),  # Emoji as int
])
...
def test_validate_type_single_none_optional() -> None:
    ...
    try:
        ...
        pytest.fail("validate_type_single raised TypeError unexpectedly for arg: None and type: int when optional is True")
...
@pytest.mark.parametrize("arg, arg_exp_type, optional, error_message", [
    ...
    (set(), int, False, re.escape("Invalid argument with value 'set()'. Expected 'int', but got 'set'.")),  # Empty set
    ((), int, False, re.escape("Invalid argument with value '()'. Expected 'int', but got 'tuple'.")),  # Empty tuple
    (b"bytes", str, False, re.escape("Invalid argument with value 'b'bytes''. Expected 'str', but got 'bytes'.")),  # Bytes
])
def test_validate_type_single_additional_invalid_cases(arg: Any, arg_exp_type: type, optional: bool, error_message: str) -> None:
