...
def test_from_string_to_langstring_manual(
    string: str, lang: Optional[str], expected_text: str, expected_lang: Optional[str]
):
...
def test_from_string_to_langstring_manual_edge_cases(
    string: str, lang: Optional[str], expected_text: str, expected_lang: Optional[str]
):
