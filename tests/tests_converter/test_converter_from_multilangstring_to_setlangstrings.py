...
def test_multilangstring_to_setlangstrings_with_multiple_languages():
    """
    ...
    ), "multilangstring_to_setlangstrings should return SetLangStrings for all languages"


def test_multilangstring_to_setlangstrings_with_single_language():
    """
    ...
    assert result == expected, "multilangstring_to_setlangstrings should handle single language correctly"


@pytest.mark.parametrize("invalid_input", [123, 5.5, True, None, [], {}, "string"])
def test_multilangstring_to_setlangstrings_invalid_type(invalid_input):
    """
